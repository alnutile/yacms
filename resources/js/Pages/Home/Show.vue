...
<template>
    <AppLayout :title="$page.props.app_name">
        <template #header>
        ...
        <div>
            <div class="max-w-full mx-auto py-10 sm:px-6 lg:px-8 dark:text-gray-300  prose">
                ...
                <section class="bg-white dark:bg-gray-900">
                    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6">
                        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                            <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                                The Blog</h2>
                            <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Even more info here</p>
                        </div>
                  ...
                  <span
                      ...
                      Tutorial
                                ...
                                <p class="mb-5 font-light text-gray-500 dark:text-gray-400">Static websites are now used
                                    to bootstrap lots of websites and are becoming the basis for a variety of tools that
                                    even influence both web designers and developers influence both web designers and
                                    developers.</p>
